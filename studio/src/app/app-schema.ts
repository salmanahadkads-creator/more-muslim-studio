      ...
      sections: [
        ...
        },
        {
          controls: {
            crossfade: {
              defaultValue: true,
              label: "Speaker crossfade",
              orderRole: "mode",
              performanceReason: "Toggles whether the ground blends per frame at speaker changes.",
              performanceRole: "responsiveness",
            ...
            breathing: {
              defaultValue: true,
              label: "Breathing & drift",
              orderRole: "mode",
              performanceReason: "Toggles the envelope breathing and slow ground push-in per frame.",
              performanceRole: "responsiveness",
            ...
            wordAccent: {
              ...
              label: "Word accent",
              orderRole: "mode",
              performanceReason: "Toggles the spoken-word accent colour per frame.",
              performanceRole: "responsiveness",
        ...
        },
        {
          controls: {
            outro: {
              ...
              description: "One outro line per row, shown on the now-streaming card at the end.",
              label: "Outro lines",
              orderRole: "input",
              performanceReason: "Outro copy re-renders the closing card's lines.",
              performanceRole: "responsiveness",
