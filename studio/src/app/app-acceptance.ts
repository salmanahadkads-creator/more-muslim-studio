...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  {
    automated: true,
    automatedTestName: "schema: audiogram.filmTexture toggles grain, gate weave, and text zoom",
    browser: true,
    browserTestName: "runtime: audiogram motion controls change the frame",
    componentType: "switch",
    evidence: "product-output",
    expectedObservable:
      "Turning Film texture off removes the living grain, gate-weave wander, and caption text zoom; on, they animate per frame; visible only for the audiogram template.",
    fixture: "Audiogram with captions.",
    id: "audiogram.filmTexture.switch",
    kind: "control",
    target: "audiogram.filmTexture",
    userAction: "Toggle Film texture in the Motion section.",
  },
  {
    automated: true,
  ...
  },
  {
    ...
    evidence: "product-output",
    expectedObservable:
      "With Highlight set to Choose, the slider selects which caption block renders as the pull-quote; visible only while Highlight is Choose.",
    fixture: "Audiogram with a multi-block SRT fixture and Highlight set to Choose.",
    id: "audiogram.highlightLine.slider",
    kind: "control",
    target: "audiogram.highlightLine",
    userAction: "Set Highlight to Choose, then drag the Highlight line slider.",
  },
  {
    automated: true,
    automatedTestName: "schema: audiogram.eyebrow overrides the frame eyebrow",
    browser: true,
    browserTestName: "runtime: audiogram eyebrow and outro text render",
    componentType: "text",
    evidence: "product-output",
    expectedObservable:
      "Typed eyebrow text replaces the top label of the audiogram; blank falls back to the episode marker; visible only for the audiogram template.",
    fixture: "Audiogram template active.",
    id: "audiogram.eyebrow.text",
    kind: "control",
    target: "audiogram.eyebrow",
    userAction: "Type an eyebrow in the Eyebrow section.",
  },
  {
    automated: true,
...
export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  ...
  },
  {
    ...
    groupingReason: "The eyebrow is the single top label of the audiogram frame.",
