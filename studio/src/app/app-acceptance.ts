...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  {
    actionCoverage: ["carousel-add-slide", "carousel-build-episode-set"],
    automated: true,
    automatedTestName: "schema: carousel actions add slides and build the episode set",
    browser: true,
    browserTestName: "app controls: carousel actions create slide layers",
    componentType: "actions",
    evidence: "product-output",
    expectedObservable:
      "Add slide creates one new selected slide layer snapshotting the current values; Build episode set creates the five-layer cover/synopsis/synopsis/credits/streaming set and selects its cover.",
    fixture: "Default cover post with no slide layers.",
    id: "carousel.actions",
    kind: "control",
    target: "carousel.slides",
    userAction: "Click Add slide, then Build episode set, in the Carousel section.",
  },
  {
    automated: true,
    automatedTestName: "schema: layers panel is enabled for slide navigation",
    browser: true,
    browserTestName: "runtime: selecting a slide layer swaps the slide values",
    componentType: "runtime",
    evidence: "product-output",
    expectedObservable:
      "Selecting another slide layer in the LayersPanel saves the current slide snapshot and renders the selected slide's template, colourway, scene, and copy.",
    fixture: "Episode set built so five slide layers exist.",
    id: "runtime.layers.selection",
    kind: "runtime",
    layerCoverage: "selection",
    userAction: "Click a different slide row in the LayersPanel.",
  },
  {
    automated: true,
    automatedTestName: "schema: hidden slide layers are excluded from the carousel ZIP",
    browser: true,
    browserTestName: "runtime: hiding a slide layer removes it from the exported ZIP",
    componentType: "runtime",
    evidence: "exported-bytes",
    expectedObservable:
      "Toggling a slide layer's visibility off excludes that slide from the numbered PNGs in the exported ZIP.",
    fixture: "Episode set built; one layer hidden before Export ZIP.",
    id: "runtime.layers.visibility",
    kind: "runtime",
    layerCoverage: "visibility",
    userAction: "Toggle a slide layer's visibility, then click Export ZIP.",
  },
  {
    automated: true,
    automatedTestName: "schema: slide layer order drives carousel numbering",
    browser: true,
    browserTestName: "runtime: reordering slide layers renumbers the exported ZIP",
    componentType: "runtime",
    evidence: "exported-bytes",
    expectedObservable:
      "Dragging a slide layer to a new position changes which slide-NN.png each slide becomes in the exported ZIP.",
    fixture: "Episode set built before reordering.",
    id: "runtime.layers.reorder",
    kind: "runtime",
    layerCoverage: "reorder",
    userAction: "Drag a slide row to a new position in the LayersPanel, then export.",
  },
  {
    automated: true,
    automatedTestName: "schema: slide layers support grouping without breaking export order",
    browser: true,
    browserTestName: "runtime: grouped slide layers keep their carousel order",
    componentType: "runtime",
    evidence: "exported-bytes",
    expectedObservable:
      "Dragging a slide row into a group keeps the slide in the carousel and preserves flattened layer order in the exported ZIP.",
    fixture: "Episode set built; one slide dragged into a group.",
    id: "runtime.layers.grouping",
    kind: "runtime",
    layerCoverage: "grouping",
    userAction: "Drag one slide row onto another to group them, then export.",
  },
  {
    automated: true,
