...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  textControlRow(
    "content.credits.list.code",
    "content.credits.list",
    "Credits template active; hidden for other templates.",
    "Each Name/Role line renders as a stacked credit pair; the field is visible only while the credits template is selected.",
    "code",
  ),
  {
    automated: true,
  ...
  },
  {
    ...
    expectedObservable:
      "The chosen colour fills the export canvas behind the slide when Include is on.",
