...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  },
  {
    ...
    evidence: "product-output",
    expectedObservable:
      "Each colourway repaints the slide ground, ink, pattern tile, and symbol per the approved pairing.",
    fixture: "Default cover post with pattern scene.",
    id: "post.colourway.select",
    kind: "control",
    optionCoverage: [
      "night",
      "oak",
    ...
    userAction: "Choose each colourway in the Colourway select.",
  },
  {
    automated: true,
