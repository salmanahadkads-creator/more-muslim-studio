...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  {
    automated: true,
    automatedTestName: "schema: scene.source gates illustration, upload, and crop controls",
    browser: true,
  ...
  {
    automated: true,
    automatedTestName: "schema: scene.imagePosition is a screen-space vector with 50/50 default",
    browser: true,
    browserTestName: "app controls: focus pad moves the image crop on both axes",
    componentType: "vector",
    controlPartCoverage: ["vector.x", "vector.y"],
    evidence: "product-output",
    expectedObservable:
      "Dragging the pad live-moves the cover-crop focus of the slide image on both axes; the pad is visible only for illustration or upload sources and hidden for pattern and solid.",
    fixture: "Cover post with an episode illustration active.",
    id: "scene.imagePosition.vector",
    kind: "control",
    target: "scene.imagePosition",
    userAction: "Drag the Focus pad horizontally and vertically.",
  },
  {
    automated: true,
    automatedTestName: "schema: scene.imageZoom is a live 1-2 slider",
    browser: true,
    browserTestName: "app controls: zoom slider scales the slide image during drag",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "The slide image scales up smoothly while the thumb is dragged, not only on release; the slider is visible only for illustration or upload sources and hidden for pattern and solid.",
    fixture: "Cover post with an episode illustration active.",
    id: "scene.imageZoom.slider",
    kind: "control",
    target: "scene.imageZoom",
    userAction: "Drag the Zoom slider from 1 toward 2.",
  },
  {
    automated: true,
...
export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  ...
  },
  {
    ...
    groupingReason:
      "Scene source and its branch controls (episode picker, upload, crop focus, zoom) all configure the slide's background material.",
    targets: [
      "scene.source",
      "scene.illustration",
      "scene.upload",
